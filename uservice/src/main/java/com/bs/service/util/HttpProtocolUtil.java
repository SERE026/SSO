...
public class HttpProtocolUtil {
	 ...
	 */
	public static void catchTmall() throws IOException, ClientProtocolException {
...
//		builder.setDefaultCookieStore(cookieStore);
		...
		/*
		 * JSONObject object = new JSONObject(result); JSONObject object2 =
		 * (JSONObject)object.get("defaultModel"); JSONObject object3 =
		 * (JSONObject)object2.get("itemPriceResultDO"); JSONObject object4 =
		 * (JSONObject)object3.get("priceInfo"); JSONObject object5 =
		 * (JSONObject)object4.get("68347779144"); JSONArray jsonArray = new
		 * JSONArray(object5.get("promotionList").toString());
		 * if(jsonArray.length()==1){ JSONObject object6 =
